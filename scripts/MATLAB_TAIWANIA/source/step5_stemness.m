...
load(strcat('../',projectId,'/',bioMarker,'/',bioMarker,'_stemness.mat'))

bind_info = bind;
anova_exprs = double(ANOVA_profile_stemness);
...
save 'Final_TF_gene_pair_stem.mat' 'Final_TF_gene_pair' '-v7.3'
save 'Finalgenename_stem.mat' 'Finalgenename' '-v7.3'
save 'Finaltfname_stem.mat' 'Finaltfname' '-v7.3'

Final_reg_ability_stem = Final_reg_ability_0;
save 'Final_reg_ability_stem.mat' 'Final_reg_ability_stem' '-v7.3'

clear Final_reg_ability_stem
clear x y z pv 
